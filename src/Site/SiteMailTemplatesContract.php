...
/**
 * @brief Site-wide customizable mail templates stored on {@see \App\Entity\HomeCustomization}.
 *
 * @date 2026-06-16
 * @author Stephane H.
 */
final class SiteMailTemplatesContract
{
    ...
    /** @var list<string> */
    public const RECRUITER_VISIT_BLOCKS = ['title', 'intro', 'company_details', 'visit_summary', 'footer'];
