...
/**
 * @brief Records PHP/test errors into the shared buffer and NDJSON log.
 *
 * @date 2026-05-02
 * @author Stephane H.
 */
final class CursorAgentPhpunitErroredSubscriber implements ErroredSubscriber
{
    ...
    /**
     * @brief Persist error metadata for Cursor agent analysis.
     *
     * @param Errored $event Error event.
     *
     * @return void
     *
     * @date 2026-05-02
